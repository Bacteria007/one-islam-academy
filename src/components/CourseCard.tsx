...
import { Clock, Users, BookOpen, Monitor, GraduationCap, Key } from "lucide-react";
  ...
  return (
      ...
      <Card className={`group hover:shadow-lg transition-all duration-300 h-full ${variantClasses[variant]}`}>
        ...
        <CardContent className="space-y-4 p-4 sm:p-6">
          ...
          <Button
            className={`w-full mt-4 ${variant === "primary" ? "bg-gradient-to-r from-primary to-primary-glow" :
